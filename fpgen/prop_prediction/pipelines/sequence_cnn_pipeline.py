...
# =============================================================================
# Модуль с реализацией пайплайна для модели CNN для работы
...
class SequenceCNNPipeline(PredictionPipeline):
    ...
    def __init__(self, weight_path: str):
        self.__model = SequenceCNN(len(VOCAB), embedding_dim=128, num_filters=64)
